...
def visualize(
    env_name="humanoid",
    model_path="models/mjx_brax_policy.mjx",
    render_path="html_renders/render.html",
):
    env = envs.get_environment(env_name)

    def get_make_inference_fn(num_envs=16384):
...
def main():
    ...
    visualize(
        env_name,
        f"models/{experiment_name}.mjx",
        render_path=f"html_renders/{experiment_name}.html",
    )
